...
public class IncapacitatedComponent implements IncapacitatedInterface, AutoSyncedComponent {
    ...
    protected int ticksUntilDeath = FabricIncapacitated.configData.getDownTicks();
    protected int downsUntilDeath = FabricIncapacitated.configData.getDownCounter();
    protected int reviveCounter = FabricIncapacitated.configData.getReviveTicks();
